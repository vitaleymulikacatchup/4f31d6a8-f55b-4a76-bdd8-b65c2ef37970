...
export const metadata: Metadata = {
  title: "Onana Coffee Shop - Premium Artisanal Coffee Experience",
  description: "Discover exceptional coffee at Onana Coffee Shop. Premium blends, expert baristas, and a warm atmosphere where quality meets tradition.",
  keywords: "coffee shop, premium coffee, artisanal coffee, specialty blends, espresso, cold brew, coffee beans",
  metadataBase: new URL("https://onanacoffee.com"),
  alternates: {
    canonical: "https://onanacoffee.com"
  },
  openGraph: {
    title: "Onana Coffee Shop - Premium Artisanal Coffee Experience",
    description: "Discover exceptional coffee at Onana Coffee Shop. Premium blends, expert baristas, and a warm atmosphere where quality meets tradition.",
    siteName: "Onana Coffee Shop",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Onana Coffee Shop - Premium Artisanal Coffee Experience",
    description: "Discover exceptional coffee at Onana Coffee Shop. Premium blends, expert baristas, and a warm atmosphere where quality meets tradition.",
    images: ["https://images.pexels.com/photos/14134083/pexels-photo-14134083.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
